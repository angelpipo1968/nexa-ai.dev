...
const security_1 = require("@nexa/security");
const security_2 = require("@nexa/security");
const audit_1 = require("@nexa/audit");
const securityMiddleware = () => {
    const detector = new security_1.InjectionDetector();
    const limiter = new security_2.AdaptiveRateLimiter();
    ...
    return async (c, next) => {
        ...
        const limitResult = await limiter.check(`${userId}:${ip}`, c.req.path, {
        // options if any
        });
